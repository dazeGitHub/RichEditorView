...
public class ItemIndex {
    ...
    private long[] defaultItems = {INSERT_IMAGE,INSERT_LINE, A, MORE, UNDO,
            REDO, BLOCK_QUOTE, BOLD, ITALIC, STRIKE_THROUGH, H1, H2, H3, H4, HALVING_LINE, LINK}; //INSERT_PRODUCT, INSERT_LINE
